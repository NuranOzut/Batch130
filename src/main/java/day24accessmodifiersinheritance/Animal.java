...
public class Animal {
    ...
    /*
        ...
        Note 8: Child ==> parent ==> Grand parent ==>Grand grand parent ...seklinde ilerleyen inheritance lara multi level
                inheritance denir
        ...
        Note 11:Java da parent tan Child e olan iliskilerde HAS A Relationship denir
                Java da Child dan parent e olan iliskilerde IS A Relationship denir
        Note 12:Java da her Class in bir tane default constructor i vardir
                Bu default constructor class in icinde gorunmez cunku default constructor "object Class"
                icindedir..Bizim class imiz default constructor a ihtiyac duydugunda parent olan "object class" a gider
                ve ordaki constructor i kullanir
