...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        System.out.println("\n*******");
        System.out.println(karakterSayGoreBuyKucSirKarSayEnBuuİlk3(meyve));


    }
    // SORU1 : List elemanlarının ilk harfi 'e' veya 'c' olanlari, Method References ile aralarında
    // bosluk bırakarak yazdıralım
    ...
    public static List<String> karakterSayGoreBuyKucSirKarSayEnBuuİlk3(List<String> meyve) {
